...
from weave_agent_sdk.prompts.loader import load_prompt, load_prompt_raw
...
class PromptRegistry:
    ...
    def get(self, name: str, context: dict | None = None) -> str:
        ...
        if name in self._cache:
            from weave_agent_sdk.prompts.loader import interpolate
        ...
        for schema_path in (file_schema_yaml, file_schema_yml, file_schema_json):
            if schema_path.exists():
                from weave_agent_sdk.prompts.loader import load_prompt_schema
