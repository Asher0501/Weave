...
from weave.loop.base import BaseLoop, _llm_call_in_flight, _tool_call_in_flight
...
class Weave:
    ...
    def _load_system_prompt(self, context: dict[str, Any] | None = None) -> str:
        ...
        if not self._config.prompts.system:
            ...
            # package-data 已声明）。
            from weave.prompts.loader import load_prompt
        ...
        #    issue 4）。
        from weave.prompts.loader import is_schema_path, load_prompt, load_prompt_schema
